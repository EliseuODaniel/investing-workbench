...
from src.investing_workbench.application.research_workspaces.reporting import (
    build_workspace_report,
)
from src.investing_workbench.infrastructure.persistence import LocalResearchWorkspacesRepository
...
class ResearchWorkspaceService:
    ...
    def save_workspace(
        ...
        *,
        ...
        workspace_id = f"research_ws_{datetime.now(UTC).strftime('%Y%m%dT%H%M%SZ')}_{token_hex(4)}"
