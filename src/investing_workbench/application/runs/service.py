...
from src.investing_workbench.infrastructure.reporting import PersistedRunHTMLReportBuilder
...
class RunBacktestService:
    ...
    def _raise_if_cancelled(self, should_cancel: CancellationProbe | None) -> None:
        if should_cancel is not None and should_cancel():
            from src.investing_workbench.application.backtest_jobs import BacktestJobCancelledError
