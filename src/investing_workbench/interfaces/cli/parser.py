...
from src.investing_workbench.domain.montecarlo import MonteCarloMethod
from src.investing_workbench.domain.optimizations import OptimizationDirection, OptimizationMode


def build_parser() -> argparse.ArgumentParser:
    """Build the CLI parser for all supported commands."""
    parser = argparse.ArgumentParser(
        description="Investing Workbench",
