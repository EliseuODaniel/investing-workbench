...
# SGS code for annualized SELIC base 252, kept for monthly legacy support.
SELIC_SGS_CODE = 1178
...
def download_selic_data(
    ...
    """Download monthly SELIC data from Banco Central do Brasil."""
    try:
        ...
        logger.info("Downloaded %s monthly SELIC rates from BCB", len(monthly))
        return monthly
